...
\begin{checklist}{No Engine Bleed -\\No Wing Anti-Ice}
  \note{If Wing Anti-Ice is not required for taxi, replace the normal "Before Taxi" checklist with the following "Before Taxi -
  No Engine Bleed" checklist}
\end{checklist}

\begin{checklist}{No Engine Bleed -\\With Wing Anti-Ice}
  \note{If Wing Anti-Ice is required for taxi, complete the normal "Before Taxi" checklist, leave the APU running, and
  use the following "Before Taxi - No Engine Bleed" checklist to configure just prior to take-off}
\end{checklist}

\begin{checklist}{Before Taxi -\\No Engine Bleed}
  \item{Generators}{On}
  \item{APU}{On}
  \item{Start Switches}{Cont}
  \item{Probe Heat}{On}
...
\begin{checklist}{After Takeoff -\\No Engine Bleed}
