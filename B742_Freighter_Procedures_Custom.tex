...
\begin{checklist}{Initial Powerup (Engineer)}
	...
	\specialcondition{Establish External Power}{
		...
		\item{External Power 1 Connection}{Close}
		\item{Split System Breaker}{Close}
		\note{External Power 2 is left OFF to provide power to the Main Deck Cargo BUS}
	}
...
\begin{continuedchecklist}
	...
	\condition{Autothrottle Control Panel}{
		\specialitem{Test}{Perform at TOD \& CLB, Check N1 Limits on Main Panel increase}
		\item{N1 Lim Mode}{Set TOD}
		\item{Autothrottle Mode}{Set N1}
	}
...
\begin{checklist}{Engineer Panel Procedure (Engineer)}
	...
	\condition{Air Conditioning} {
		...
		\item{Trim Air}{On}
		\item{Recirc Fans}{On as Desired}
	}
...
\begin{continuedchecklist}
	\specialcondition{Checks Upper Right Section} {
		...
		\item{Nose Door Indocators}{Test, Check Lights}
		\item{Main Deck Cargo Smoke Detector}{Test A \& B, Check All Lights \& Warning Bell}
	}
...
\item{Oxygen Valve}{Check in Green Band}
\end{continuedchecklist}
...
\begin{checklist}{Preflight Preparations (Pilots)}
	...
	\item{Autothrottle \& N1 Limit Mode}{Check N1 \& TOD}
	\item{Rating Select}{Set as Desired \& Calculated}
...
\begin{checklist}{Pushback \& Engine Start Preparations}
	...
	\item{PACKs}{Turn One Off (One is left On)}
	...
	\condition{Hydraulic Pressurization} {
		...
		\item{Air Hydraulic Pump 1}{On if Pushback Desired}
		\item{Electric Hydraulic Pump (System 4)}{On}
	}
...
\begin{checklist}{Pushback}
	...
	\item{Hydraulic Pressure 1 \& 4}{Verify as Desired}
	\item{Pushback}{Start}
...
\begin{continuedchecklist}
	...
	\item{Autobrake for Takeoff}{Arm}
\end{continuedchecklist}
...
\begin{checklist}{Taxi}
	...
	\item{Before Takeoff Checklist to the Line}{Perform}
	\condition{After Leaving Ramp} {
		\item{Autothrottle \& N1 Limit Mode}{Check N1 \& TOD}
		\item{Rating Select}{Check}
...
\begin{checklist}{Takeoff}
	...
	\item{Autothrust}{On}
	\item{Autothrottle N1 Indication}{Check On}
...
\begin{continuedchecklist}
	...
	\condition{Passing 10000ft}{
		\item{Landing Lights}{Turn On}
		\item{Logo Lights}{On If Desired}
		\item{Seatbelt Signs}{Check On}
		\item{N1 Lim Mode}{Go Around}
		\item{Humidifier}{Off}
		\item{Descent \& Approach Checklist}{Perform, Skip Radio \& Nav Instruments if necessary}
	}
...
\begin{checklist}{After Landing \& Taxi}
	...
	\item{Fuel Screenshot}{Take}
	\item{APU Power Selector}{On}
	\item{After Landing Checklist}{Perform, Skip Transponder}
...
\begin{checklist}{Parking}
	...
	\item{Shutdown Checklist}{Perform To Line}
\end{checklist}
...
\begin{checklist}{Shutdown}
	...
	\specialitem{Oxygen Valve}{Close}
...
\begin{continuedchecklist}
	...
	\specialitem{Shutdown Checklist}{Finish}
\end{continuedchecklist}
