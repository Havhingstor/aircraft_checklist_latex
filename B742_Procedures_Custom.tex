...
\begin{continuedchecklist}
	...
	\specialcondition{Window Heat Tests} {
	...
	\specialcondition{Warning Tests} {
...
\begin{checklist}{Engineer Panel Procedure (Engineer)}
	...
	\item{Cabin Pressurization Altitude}{Set Cruise Alt + 1000ft on Black Band}
\end{checklist}
...
\begin{checklist}{Shutdown}
	...
	\specialitem{Recirc Fans 2, 3, 4}{Off}
